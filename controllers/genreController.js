...
exports.genre_create_post =  [ // Specifies an array of middleware functions (each method is called in order).
...
exports.genre_update_post = [
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            res.render('book_form', { title: 'Update Genre', genre: genre, errors: errors.array() });
